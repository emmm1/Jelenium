...
public class NewRecordSBtest {
  ...
  public void NewRecordSBtest() {
    ...
    gotoAddNewPage();
    fillOutForm(new ContactDate("Тест", "Тестович", "Тестовый", "ттт", "Дорогой", "Тест продакшн", "РФ, Тестовая область, г. Тестовск, тестовый тупик, д. 26, кв 13",
  ...
  private void fillOutForm(ContactDate cDate) {
